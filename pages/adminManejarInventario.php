    ...
    if($infoUsuarioAdmin != 1){
        ...
        while($filas = mysqli_fetch_array($resAlumnos, MYSQLI_BOTH )){ 
            $trAlumnos .= "<tr>
                ...
                <td>
                &nbsp;&nbsp;&nbsp;&nbsp;<i class='fas fa-minus fa-2x red-text text-darken-3 disminuirInventario' data-nombre='$filas[0]'></i>&nbsp;&nbsp;&nbsp;&nbsp;
                    <i class='fas fa-plus fa-2x green-text text-darken-3 aumentarInventario' data-nombre='$filas[0]'></i>&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>";
        }
?>
